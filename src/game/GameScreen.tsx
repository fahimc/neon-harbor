...
export function GameScreen({ frozen = false }: { frozen?: boolean }) {
  ...
  return <main className={`game-screen ${frozen ? 'game-screen--frozen' : ''}`} onPointerDown={startLook} onPointerMove={moveLook} onPointerUp={endLook} onPointerCancel={endLook}><GameScene frozen={frozen} />
    ...
    {!frozen && <TouchControls />}<div className="game-hint">WASD / JOYSTICK TO MOVE · DRAG TO LOOK · SPACE TO JUMP · E TO DRIVE</div>
  </main>
}
